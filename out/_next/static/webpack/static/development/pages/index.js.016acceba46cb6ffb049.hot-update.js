...
var SectionWrapper = ({
  ...
  return __jsx(react_bootstrap_Container__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    children: children,
    onScroll: e => {
      elem.current.querySelector('.horizontal-scroll__container').style.transform = "matrix((-".concat(elem.current.scrollTop, "px)");
    },
    __self: undefined,
    __source: {
...
//# sourceMappingURL=index.js.016acceba46cb6ffb049.hot-update.js.map