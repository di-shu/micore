...
elem.current.querySelector('.wh-wrap').style.height = "".concat(elem.current.querySelector('.horizontal-scroll__container').style.width);
var SectionWrapper = ({
  children,
  noPadding,
  className
...
/*!*********************************!*\
  !*** ./src/Components/index.js ***!
  \*********************************/
/*! exports provided: HomePage, AboutPage, ServicesPage, BrandPage, OtherPage, LandingPage, CorporatePage, Socials, MenuLinks, TeamList, SkillsList, GlobalStyle, ServicesList, Sizes, NewProjectsList, Portfolios, Services, FullPageWrapper, FooterSection, Blob, Layout, ScrollBox, ActiveLink, SeeMoreLink, SectionTitle, SectionDesc, SocialsWrap, MainWrapper, ImageWrapper, ApolloStatue, SectionLayout, MyScrollAnimation, TabWrap, TeamModal, InputControl, MenuContainer, Header, MetaHead, ServiceQuote, ServiceTarget, ServiceFeedback, ServiceWorkStages, ServiceMainSection, ServiceShortPortfolio, ServicePriceMiscalculations, FlipBook, FontExample, SectionLine, ProjectColor, SectionSlider, TypeSomething, ProjectInfoWrap, BottomNavigation, ProjectsNavigation, ProjectMainSection, ProjectAboutSection, HorizontalScroll, SectionWrapper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
//# sourceMappingURL=index.js.0b1ea53eee63e122a8fd.hot-update.js.map