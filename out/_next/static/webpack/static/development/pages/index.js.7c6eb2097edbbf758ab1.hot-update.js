...
var SectionWrapper = ({
  ...
  return __jsx(react_bootstrap_Container__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    children: children,
    onScroll: e => {
      elem.current.querySelector('.wh-wrap').style.height = "".concat(elem.current.querySelector('.horizontal-scroll__container').width, "px");
...
//# sourceMappingURL=index.js.7c6eb2097edbbf758ab1.hot-update.js.map