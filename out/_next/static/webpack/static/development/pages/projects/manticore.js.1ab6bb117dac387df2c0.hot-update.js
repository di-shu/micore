...
var SectionWrapper = ({
  ...
  return __jsx(react_bootstrap_Container__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    children: children,
    onScroll: e => {
      elem.current.querySelector('.horizontal-scroll').style.transform = "translateX(-".concat(elem.current.scrollTop, "px)");
    },
    __self: undefined,
    __source: {
...
//# sourceMappingURL=manticore.js.1ab6bb117dac387df2c0.hot-update.js.map