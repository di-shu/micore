  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    document.addEventListener('scroll', function () {
      ...
      if (wrapper.current) {
        ...
        console.log(window.scrollY, elem.getBoundingClientRect().height + 50);

        if (window.scrollY > elem.getBoundingClientRect().height + 50) {
          lastHeight = elem.getBoundingClientRect().height + 50;
          setScrolled(false);
...
//# sourceMappingURL=manticore.js.23e40aa2cabe5467361f.hot-update.js.map