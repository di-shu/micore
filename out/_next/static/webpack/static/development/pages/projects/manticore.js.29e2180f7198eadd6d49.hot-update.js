...
var DevelopingLogo = () => {
  ...
  var handleScroll = e => {
    ...
    if (windowOffset > window.scrollY) {
      console.log("scrolling up");
    } else if (windowOffset < window.scrollY) {
      console.log("scrolling down");
    }

    undefined.prev = window.scrollY;
  };
...
//# sourceMappingURL=manticore.js.29e2180f7198eadd6d49.hot-update.js.map