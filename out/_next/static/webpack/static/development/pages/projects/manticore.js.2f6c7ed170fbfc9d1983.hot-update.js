...
var SectionWrapper = ({
  ...
  return __jsx(react_bootstrap_Container__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    children: children,
    onScroll: e => {
      elem.current.querySelector('.horizontal-scroll__container').style.transform = "translate3(-".concat(elem.current.scrollTop, "px)");
    },
    __self: undefined,
    __source: {
...
//# sourceMappingURL=manticore.js.2f6c7ed170fbfc9d1983.hot-update.js.map