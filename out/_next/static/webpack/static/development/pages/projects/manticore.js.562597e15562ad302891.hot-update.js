...
var setup = (_ref) => {
  ...
  return (p5, canvasParentRef) => {
    p5.createCanvas(other.statueW, other.statueH).parent(canvasParentRef); // p5.background(0)
...
var draw = p5 => {
  p5.clear(); // p5.background('rgba(255, 255, 255, 0)')
...
//# sourceMappingURL=manticore.js.562597e15562ad302891.hot-update.js.map