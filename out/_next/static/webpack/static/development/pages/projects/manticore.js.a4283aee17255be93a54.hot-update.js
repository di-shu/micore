...
var SectionWrapper = ({
  ...
  return __jsx(react_bootstrap_Container__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    children: children,
    onScroll: e => {
      elem.current.querySelector('.wh-wrap').style.height = "".concat(elem.current.querySelector('.horizontal-scroll__container').style.width, "px");
...
//# sourceMappingURL=manticore.js.a4283aee17255be93a54.hot-update.js.map