...
var SectionWrapper = ({
  ...
  return __jsx(react_bootstrap_Container__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    children: children,
    onScroll: e => {
      elem.current.querySelector('.horizontal-scroll__container').style.transform = "translateX(-".concat(elem.current.scrollTop, "px)");
    },
    __self: undefined,
    __source: {
...
//# sourceMappingURL=manticore.js.f19aec3097c0ef34e436.hot-update.js.map