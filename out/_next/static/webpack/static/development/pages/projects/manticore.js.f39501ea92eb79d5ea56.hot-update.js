...
var SectionWrapper = ({
  ...
  return __jsx(react_bootstrap_Container__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    children: children,
    onScroll: e => {
      elem.current.querySelector('.horizontal-scroll').style.transform = "translateX(".concat(elem.current.scrollTop, ")");
    },
    __self: undefined,
    __source: {
...
//# sourceMappingURL=manticore.js.f39501ea92eb79d5ea56.hot-update.js.map