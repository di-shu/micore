...
var HorizontalScroll = ({
  ...
  var handleScroll = e => {
    ...
    if (wrapper.current.getBoundingClientRect().top <= 0) {
      setIsBottom(true);
    } else if (window.pageYOffset < wrapper.current.getBoundingClientRect().top) {
      setIsBottom(false);
    }
  };

  var setHandler = () => {// console.log('isBottom');
  };
...
//# sourceMappingURL=pride-logistic.js.09898c5e02faef0fce0c.hot-update.js.map