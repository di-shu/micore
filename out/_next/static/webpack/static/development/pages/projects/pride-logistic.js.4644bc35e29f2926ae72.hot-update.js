...
var HorizontalScroll = ({
  ...
  var handleScroll = e => {
    ...
    if (wrapper.current.getBoundingClientRect().top <= 0) {
      setIsBottom(true);
      window.scrollTo(wrapper.current.scrollLeft, wrapper.current.getBoundingClientRect().top);
      console.log(wrapper.current.getBoundingClientRect().left, wrapper.current.getBoundingClientRect().top);
    }
  };
...
//# sourceMappingURL=pride-logistic.js.4644bc35e29f2926ae72.hot-update.js.map