...
var HorizontalScroll = ({
  ...
  var handleScroll = e => {
    ...
    var windowBottomPosition = Math.round(wrapper.current.scrollY + wrapper.current.innerHeight);
    console.log(windowBottomPosition);

    if (wrapper.current.getBoundingClientRect().top <= 0) {
      setIsBottom(true);
      window.scrollTo(wrapper.current.scrollLeft, windowBottomPosition);
...
//# sourceMappingURL=pride-logistic.js.6ab03806af70ac5353a6.hot-update.js.map