...
var HorizontalScroll = ({
  ...
  var handleScroll = e => {
    ...
    if (wrapper.current.getBoundingClientRect().top <= 0) {
      setIsBottom(true);
      window.scrollTo(wrapper.current.getBoundingClientRect().top, wrapper.current.scrollLeft);
...
//# sourceMappingURL=pride-logistic.js.8c8668440e494df69e79.hot-update.js.map