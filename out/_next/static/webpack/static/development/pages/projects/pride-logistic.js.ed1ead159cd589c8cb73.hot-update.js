...
var HorizontalScroll = ({
  ...
  var handleScroll = e => {
    ...
    if (wrapper.current.getBoundingClientRect().top <= 0) {
      setIsBottom(true);
      window.scrollTo(0, wrapper.current.getBoundingClientRect().bottom);
      console.log(wrapper.current.getBoundingClientRect().bottom);
...
//# sourceMappingURL=pride-logistic.js.ed1ead159cd589c8cb73.hot-update.js.map