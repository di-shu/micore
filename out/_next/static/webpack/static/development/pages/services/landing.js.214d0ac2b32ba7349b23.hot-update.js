...
var Portfolios = {
  getSlicedTabs: function getSlicedTabs(sliceCount = 6) {
    return this.getTabs().map(tab => {
      var res = tab.content.slice(0, sliceCount);
      console.log(res); // tab.content.length > 0 && tab.content.slice(0, sliceCount)
  ...
  getWebSites: function getWebSites() {
    return _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_0___default()(NewProjectsList.getByKeys(['zlata_trade', 'fcbalkans', 'pride_logistic', 'vlady', 'bessarabskiy', 'marinist']));
  },
  getUIUX: function getUIUX() {
    return _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_0___default()(NewProjectsList.getByKeys(['bee_games', 'attic']));
  },
  getBranding: function getBranding() {
    return _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_0___default()(NewProjectsList.getExcept(['bee_games']));
  }
};
var Services = {
...
//# sourceMappingURL=landing.js.214d0ac2b32ba7349b23.hot-update.js.map