...
var NewProjectsList = {
  ...
  getExcept: function getExcept(keys) {
    var newObj = this.projects;
    keys.forEach(key => {
      delete newObj[key];
    });
    return _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_1___default()(newObj);
  },
  getALl: function getALl() {
    return _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_1___default()(this.projects);
  },
...
var HomePortfolio = ({
  ...
  console.log(_Config__WEBPACK_IMPORTED_MODULE_3__["Portfolios"].getBranding());
...
//# sourceMappingURL=landing.js.494ce22f097c5abde0bf.hot-update.js.map