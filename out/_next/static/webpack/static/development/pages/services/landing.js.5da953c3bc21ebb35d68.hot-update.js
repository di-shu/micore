...
var NewProjectsList = {
  ...
  getByKeys: function getByKeys(keys) {
    var res = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.projects).filter(key => keys.includes(key)); // .reduce((obj, key, index) => {
...
//# sourceMappingURL=landing.js.5da953c3bc21ebb35d68.hot-update.js.map