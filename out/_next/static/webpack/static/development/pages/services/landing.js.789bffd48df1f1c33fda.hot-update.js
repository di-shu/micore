...
var NewProjectsList = {
  ...
  getByKeys: function getByKeys(keys) {
    var res = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.projects).sort(function (a, b) {
      console.log(a, b);
    }).filter(key => keys.includes(key)); // .reduce((obj, key, index) => {
...
//# sourceMappingURL=landing.js.789bffd48df1f1c33fda.hot-update.js.map