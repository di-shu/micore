...
var NewProjectsList = {
  ...
  getByKeys: function getByKeys(keys) {
    ...
    var res = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.projects).sort().filter(key => keys.includes(key)).reduce((arr, key, index) => {
...
//# sourceMappingURL=landing.js.8bf927a84efda4ffba26.hot-update.js.map