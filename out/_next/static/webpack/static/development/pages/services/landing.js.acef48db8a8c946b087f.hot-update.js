...
var NewProjectsList = {
  ...
  getByKeys: function getByKeys(keys) {
    return _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.projects).filter(key => keys.includes(key)).reduce((obj, key) => {
      obj[key] = this.projects[key];
      return obj;
    }, {});
  }
};
...
/*!*********************************!*\
  !*** ./src/Components/index.js ***!
  \*********************************/
/*! exports provided: HomePage, AboutPage, ServicesPage, BrandPage, OtherPage, LandingPage, CorporatePage, Socials, MenuLinks, TeamList, SkillsList, GlobalStyle, ServicesList, FullPageWrapper, FooterSection, Blob, Layout, ScrollBox, ActiveLink, SeeMoreLink, SectionTitle, SectionDesc, SocialsWrap, MainWrapper, ImageWrapper, ApolloStatue, SectionLayout, SectionWrapper, MyScrollAnimation, TabWrap, TeamModal, AllProjects, NewProjectsList, ProjectsList, InputControl, MenuContainer, Header, MetaHead, ServiceQuote, ServiceTarget, ServiceFeedback, ServiceWorkStages, ServiceMainSection, ServiceShortPortfolio, ServicePriceMiscalculations, FlipBook, FontExample, SectionLine, ProjectColor, SectionSlider, TypeSomething, ProjectInfoWrap, BottomNavigation, ProjectsNavigation, ProjectMainSection, ProjectAboutSection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
//# sourceMappingURL=landing.js.acef48db8a8c946b087f.hot-update.js.map