...
export const Portfolios = {
  ...
  getBranding: function () {
    return Object.values(
      NewProjectsList.getExcept(["bee_games", "bezcreditov", "tfc", "my_house"])
    );
  },
};
...
export const Services = {
  getLanding: function () {
    return Object.values(
      NewProjectsList.getByKeys(["pride_logistic", "vlady", "bee_games"])
    );
  },
  getCorporate: function () {
    return Object.values(
      NewProjectsList.getByKeys(["pride_group", "marinist", "zlata_trade"])
    );
  },
  getBrand: function () {
    return Object.values(
      NewProjectsList.getByKeys(["fcbalkans", "zlata_trade", "two_are"])
    );
  },
  getOthers: function () {
    return Object.values(
      NewProjectsList.getByKeys(["fcbalkans", "marinist", "pride_logistic"])
    );
  },
};
