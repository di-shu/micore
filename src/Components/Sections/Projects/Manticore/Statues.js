...
export const Statues = () => {
    return(
        <SectionLayout id="manticore-statues">
            ...
            <SectionDesc>
                Ключая особенность сайта - это статуи. Страшно представить сколько ушло времени на поиск, обработку, шлифовку. Но в этом наша уникальность и оно того стоило.
            </SectionDesc>
            <ImageWrapper isDot/>
